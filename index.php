...
<html>
	...
	*/
	...
	//var_dump(getMp3StreamTitle('http://stream02.exeamedia.com:8000/elcorralwidgetyrespaldo', 19200));
	?>
				...
				<div id="header">
					...
					<div id="playerContainer">			
						...
						<div id="jp_container_1" class="jp-audio">
							<div class="jp-artist">
					            <p id="artist">Energía FM</p>
					        </div>

							<div class="jp-title">
					            <p id="title">Energía FM</p>
					        </div>
						    ...
						    <div class="jp-nextSong">
						    	<h3>Canción anterior</h3>
						    	<p id="previousSong">Artista - Canción</p>
						    </div>
